...
library(proxy,quietly = T, verbose=F)
...
## convert numeric(factors) to binary
...
## make a binary matrix for mem_no~products if product reviewed or not
...
## keep only lower triangular matrix; set  NA -> upper triangular elements
